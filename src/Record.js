...
function Record({window,record,type,handleType,format,handleChange,year,handleYear,team,handleTeam,opo,handleOpo,submit2,handleDrawerToggle,mobileOpen,loading}) {
  ...
  const drawer = (
    <div>
      <Toolbar />
        ...
        <div > <h3 className='filters'>Filters</h3></div>
      ...
      <Button onClick={submit2} className="btn" variant='contained' >sumbit</Button>
      ...
      >
        <Toolbar>
          ...
          <Typography variant="h6" noWrap component="div">
            Records 
            <Link to="/"><AiOutlineHome className='home-nav'/></Link>
          </Typography>
        </Toolbar>
      </AppBar>
      <Box
      ...
      <Table sx={{ minWidth: 350 }} aria-label="simple table">
        <TableHead >
          <TableRow>
            ...
            {[record].flat()?<div className='head' >  
