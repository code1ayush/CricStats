...
function Ranking({window,rankType,handleRank,bowler,handleBowler,men,handleMen,submitrank,ranking,handleDrawerToggles,mobileOpens}) {
  ...
  const drawer = (
    <div>
     ...
     <FormControl sx={{ m: 1, minWidth: 100 }}>
      ...
      <Button onClick={submitrank} className="btn" variant='contained' >sumbit</Button>
    </div>
    </div>
  );
